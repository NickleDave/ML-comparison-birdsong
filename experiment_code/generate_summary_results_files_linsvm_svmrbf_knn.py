...
for bird_ID, bird_data in data_by_bird.items():
    ...
    with shelve.open(results_fname) as shv:
        ...
        shv['svm_Tach_test_rnd_acc'] = svm_Tach_test_rnd_acc
        shv['svm_Tach_test_rnd_acc_mn'] = np.mean(svm_Tach_test_rnd_acc,axis=0)
        shv['svm_Tach_test_rnd_acc_std'] = np.std(svm_Tach_test_rnd_acc,axis=0)
        ...
        shv['svm_Tach_holdout_avg_acc_std'] = np.std(svm_Tach_holdout_avg_acc,axis=0)
        shv['svm_Tach_holdout_cm_arr'] = svm_Tach_holdout_cm_arr

        shv['svm_Tach_test_acc_by_label'] = svm_Tach_test_acc_by_label
        shv['svm_Tach_test_avg_acc'] = svm_Tach_test_avg_acc
        shv['svm_Tach_test_avg_acc_mn'] = np.mean(svm_Tach_test_avg_acc,axis=0)
        shv['svm_Tach_test_avg_acc_std'] = np.std(svm_Tach_test_avg_acc,axis=0)
        shv['svm_Tach_test_cm_arr'] = svm_Tach_test_cm_arr
