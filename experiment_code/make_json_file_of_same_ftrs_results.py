...
sys.path.append('C:/Users/dnicho4/Documents/IPython Notebooks/ML-comparison-birdsong/linsvm_svmrbf_knn_same_ftrs_results/')
...
SUMMARY_SHV_BASE_FNAME = '_test_same_ftr_summary_results'
...
with open('same_ftrs_results_dict.json','w') as outfile:
