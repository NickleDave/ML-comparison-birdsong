...
SOURCE_RESULTS_DIR = './linsvm_svmrbf_knn_results/'
SOURCE_SHELVE_BASE_FNAME = 'linsvm_svmrbf_knn_results_'
TARGET_RESULTS_DIR = './linsvm_svmrbf_knn_results_080616/'
    ...
    for ind, num_songs in enumerate(NUM_SONGS_TO_TEST):
        ...
        for replicate in REPLICATES:
            ...
            results_shelve_fname = \
                TARGET_RESULTS_DIR + RESULTS_SHELVE_BASE_FNAME + str(birdID) + ", " + str(num_songs) + ' songs, replicate ' + str(replicate) + '.db'                        
